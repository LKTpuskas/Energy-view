...
const Description = () => {
  return (
    <Wrapper fullBleed>
      ...
      <DescriptionTitle title='Description' customStyle={`background-color: #0a2859;`}/>
      <DescriptionContent>
      Available in 7 watts, 9 watts, 11
      watts Spiral Light bulb in B22,
      bulb switches on instantly, no
      wiaint around warm start and
